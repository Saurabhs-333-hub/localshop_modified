...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[50rem] flex items-center justify-center relative p-20"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[30rem] w-full border-4 border-[#6C6C6C] p-6 bg-[#222222] rounded-[30px] shadow-2xl"
        >
